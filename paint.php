...
<!--=================== PHP CODE TO SELECT ALL FROM PAINTING TABLE ===========================-->
  <?php
...
<!--========================= BRUSH-PEN ICON ===============================-->
  <section class="container">
    <h1 class="text-center">Painting</h1>
          ...
          <div class='panel-group'>
            <div class='panel panel-default'>
              ...
              <div id='collapse{$row['id']}' class='panel-collapse collapse'>
                ...
                <div class='panel-footer'>Call to Hold<a href='contact.php'><img class='phone-icon'src='kettle-images/smartphone.svg' alt='phone icon'></a></div>
              </div>
            </div>
          </div>
